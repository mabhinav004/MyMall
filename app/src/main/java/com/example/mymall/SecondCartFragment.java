...
public class SecondCartFragment extends Fragment {
                ...
                if (validateData()) {
                 txtWarning.setVisibility(View.GONE);
                    ...
                    if(null!=cartItems){
                        ...
                        //passing order object into thirdCartFragment by converting into json
                        Gson gson=new Gson();
    ...
    private boolean validateData() {
        ...
        if (edtTxtAddress.getText().toString().equals("") || edtTxtEmail.getText().toString().equals("") ||
                edtTxtPhoneNumber.getText().toString().equals("") || edtTxtZipCode.getText().toString().equals("")) {
              return false;
        }
         return true;
    }
